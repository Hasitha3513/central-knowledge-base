...
The reason is not returned or copied into audit. The dedicated GPS Exceptions page and warnings on existing
Tracking screens remain unavailable until CS07, so this backend capability is not yet a completed UI workflow.
