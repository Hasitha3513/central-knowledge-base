...
## US-53 Journey Replay Permissions (Implemented in V93)
...
V93 seeds exactly these two permissions and conditionally grants them only to existing `ADMIN`,
...
## US-87 CS05 permissions (catalogued, ungranted and inactive)
