...
| Tracking | US-51 | Authoritative engine-running plus movement telemetry | DECISION_SELECTED / IMPLEMENTATION_NOT_AUTHORIZED; current V1/V2 engine value represents ignition semantics, Flespi does not map it, and no device-native engine-running source is approved |
