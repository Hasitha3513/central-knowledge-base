...
The ARB disposition keeps US-48 physical acceptance `ON_HOLD_EXTERNAL_PREREQUISITE` until the physical FMC130 and live Flespi prerequisites exist. The hold is not completion, acceptance or waiver. Downstream technical work may consume proven contracts without inheriting field acceptance. US-49 is accepted; US-50, US-52, US-53, US-54 and US-55 are technically complete with governed field/external holds; US-51 remains blocked by missing engine-state capability. Accounting remains 73/87 and Flyway is V100. The exact open US-55 acceptance queue is `US-55-HANDLE-GPS-EDGE-CASES-FINAL-ACCEPTANCE-001`; the independent queue is `US-55-PROVIDER-POLLING-CANONICAL-KAFKA-REMEDIATION-001`, followed by `US-55-TRACCAR-ADAPTER`.
