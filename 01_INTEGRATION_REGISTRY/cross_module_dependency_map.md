...
| Tracking | US-55 | Provider-independent loss/delay/trust plus coordinate, accuracy, ordering, impossible-movement, binding and recovery rules; unavailable optional signals remain absent/UNKNOWN | IMPLEMENTATION_IN_PROGRESS / CS03_COMPLETE; V96 durable optional evidence/capabilities; no physical-acceptance inheritance |
