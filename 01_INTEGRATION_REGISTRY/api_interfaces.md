...
| Fuel Exceptions (US-38) | Planned `/api/v1/fuel/exceptions` list/create/detail, evidence, notes, review, correction request/approve/reject, resolve, escalate, and history routes | Fuel | `PRODUCT_DECISIONS_FROZEN / IMPLEMENTATION_NOT_STARTED`. Six safe categories; explicit commands only; default page 20/max 100; no generic PATCH/delete/raw-source edit/fraud verdict/public route. |
